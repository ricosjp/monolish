...
private:
  ...
  int monolish_LOBPCG(matrix::CRS<Float> const &A, Float &lambda, vector<Float> &x);

public:
  /**
   * @brief calculate eigenvalues and eigenvectors or A by LOBPCG method(lib=0: monolish)
