...
for prec in double float int size_t; do
  ...
  */ "
  echo "[[nodiscard]] $prec Allreduce($prec val);"
done
...
for prec in double float int size_t; do
  ...
  * @param val scalar value
  */ "
  echo "[[nodiscard]] $prec Allreduce_sum($prec val);"
done
...
for prec in double float int size_t; do
  ...
  * @param val scalar value
  */ "
  echo "[[nodiscard]] $prec Allreduce_prod($prec val);"
done
...
for prec in double float int size_t; do
  ...
  * @param val scalar value
  */ "
  echo "[[nodiscard]] $prec Allreduce_max($prec val);"
done
...
for prec in double float int size_t; do
  ...
  * @param val scalar value
  */ "
  echo "[[nodiscard]] $prec Allreduce_min($prec val);"
done
