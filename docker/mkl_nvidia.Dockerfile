FROM ghcr.io/ricosjp/allgebra/cuda11_4/clang12/mkl:21.09.0
...
RUN wget https://github.com/ricosjp/monolish/releases/download/0.14.2/monolish_0.14.2-1+mkl+nvidia_amd64.deb \
 && apt install -y ./monolish_0.14.2-1+mkl+nvidia_amd64.deb \
 && rm ./monolish_0.14.2-1+mkl+nvidia_amd64.deb \
 && apt-get clean \
