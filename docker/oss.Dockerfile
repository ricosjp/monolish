...
RUN wget https://github.com/ricosjp/monolish/releases/download/0.14.1/monolish_0.14.1-1+oss_amd64.deb \
 && apt install -y ./monolish_0.14.1-1+oss_amd64.deb \
 && rm ./monolish_0.14.1-1+oss_amd64.deb
