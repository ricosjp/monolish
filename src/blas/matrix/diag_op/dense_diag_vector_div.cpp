...
template void
monolish::matrix::Dense<double>::diag_div(const view1D<matrix::Dense<double>, double> &vec);
template void
monolish::matrix::Dense<float>::diag_div(const view1D<matrix::Dense<float>, float> &vec);
} // namespace matrix
} // namespace monolish
