...
template <>
void monolish::view_Dense<vector<double>, double>::diag_div(
    const double alpha) {
  Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_Dense<matrix::Dense<double>, double>::diag_div(
    const double alpha) {
  Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_Dense<tensor::tensor_Dense<double>, double>::diag_div(
    const double alpha) {
  Dense_diag_div_core(*this, alpha);
}
...
template <>
void monolish::view_Dense<vector<float>, float>::diag_div(const float alpha) {
  Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_Dense<matrix::Dense<float>, float>::diag_div(
    const float alpha) {
  Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_Dense<tensor::tensor_Dense<float>, float>::diag_div(
    const float alpha) {
  Dense_diag_div_core(*this, alpha);
}
...
template <>
void monolish::view_Dense<vector<float>, float>::diag_div(
