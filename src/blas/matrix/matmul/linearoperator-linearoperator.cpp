...
// double ////////////////
void blas::matmul(const matrix::LinearOperator<double> &A, const matrix::LinearOperator<double> &B,
...
// float ////////////////
void blas::matmul(const matrix::LinearOperator<float> &A, const matrix::LinearOperator<float> &B,
