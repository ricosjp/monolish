...
// LinearOperator /////////////////////////
void blas::matadd(const matrix::LinearOperator<float> &A, const matrix::LinearOperator<float> &B,
...
// LinearOperator ///////
void blas::matsub(const matrix::LinearOperator<float> &A, const matrix::LinearOperator<float> &B,
                  matrix::LinearOperator<float> &C){
  Logger &logger = Logger::get_instance();
  logger.func_in(monolish_func);
