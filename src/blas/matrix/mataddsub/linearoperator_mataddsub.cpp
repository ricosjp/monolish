...
namespace monolish {
  ...
  namespace{
    ...
    template<typename F>
      void matadd_core(const matrix::LinearOperator<F> &A,
          const matrix::LinearOperator<F> &B, matrix::LinearOperator<F> &C) {
  ...
  namespace blas{
    void matadd(const matrix::LinearOperator<double> &A,
        const matrix::LinearOperator<double> &B, matrix::LinearOperator<double> &C){
      matadd_core(A, B, C);
    }
    ...
    void matadd(const matrix::LinearOperator<float> &A,
        const matrix::LinearOperator<float> &B, matrix::LinearOperator<float> &C){
      matadd_core(A, B, C);
    }
