...
double nrm2(const view1D<matrix::Dense<double>, double> &x) { return Dnrm2_core(x); }
float nrm2(const vector<float> &x) { return Snrm2_core(x); }
float nrm2(const view1D<vector<float>, float> &x) { return Snrm2_core(x); }
float nrm2(const view1D<matrix::Dense<float>, float> &x) { return Snrm2_core(x); }
...
void nrm2(const view1D<matrix::Dense<float>, float> &x, float &ans) { ans = nrm2(x); }
