...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
    for arg2 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
      if [ $prec = "double" ]
      then
        echo "$prec dot($C $arg1 &x, $C $arg2 &y){return Ddot_core(x, y);}"
      else
        echo "$prec dot($C $arg1 &x, $C $arg2 &y){return Sdot_core(x, y);}"
      fi
    done
  done
done
...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
    for arg2 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
      echo "void dot($C $arg1 &x, $C $arg2 &y, $prec &ans){ ans = dot(x, y); }"
    done
  done
done
...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
      if [ $prec = "double" ]
      then
        echo "$prec nrm1($C $arg1 &x){ return Dnrm1_core(x); }"
      else
        echo "$prec nrm1($C $arg1 &x){ return Snrm1_core(x); }"
      fi
  done
done
...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
    echo "void nrm1($C $arg1 &x, $prec &ans){ ans = nrm1(x); }"
  done
done
...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
      if [ $prec = "double" ]
      then
        echo "$prec nrm2($C $arg1 &x){ return Dnrm2_core(x); }"
      else
        echo "$prec nrm2($C $arg1 &x){ return Snrm2_core(x); }"
      fi
  done
done
...
for prec in double float; do
  for arg1 in vector\<$prec\> view1D\<vector\<$prec\>,$prec\> view1D\<matrix::Dense\<$prec\>,$prec\>; do
    echo "void nrm2($C $arg1 &x, $prec &ans){ ans = nrm2(x); }"
  done
done
