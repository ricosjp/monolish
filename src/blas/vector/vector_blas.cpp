...
void axpy(const double alpha, const vector<double> &x, vector<double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const vector<double> &x, view1D<vector<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const vector<double> &x, view1D<matrix::Dense<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<vector<double>,double> &x, vector<double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<vector<double>,double> &x, view1D<vector<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<vector<double>,double> &x, view1D<matrix::Dense<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<matrix::Dense<double>,double> &x, vector<double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<matrix::Dense<double>,double> &x, view1D<vector<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const double alpha, const view1D<matrix::Dense<double>,double> &x, view1D<matrix::Dense<double>,double> &y) {Daxpy_core(alpha, x, y);}
void axpy(const float alpha, const vector<float> &x, vector<float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const vector<float> &x, view1D<vector<float>,float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const vector<float> &x, view1D<matrix::Dense<float>,float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<vector<float>,float> &x, vector<float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<vector<float>,float> &x, view1D<vector<float>,float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<vector<float>,float> &x, view1D<matrix::Dense<float>,float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<matrix::Dense<float>,float> &x, vector<float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<matrix::Dense<float>,float> &x, view1D<vector<float>,float> &y) {Saxpy_core(alpha, x, y);}
void axpy(const float alpha, const view1D<matrix::Dense<float>,float> &x, view1D<matrix::Dense<float>,float> &y) {Saxpy_core(alpha, x, y);}

void axpyz(const double alpha, const vector<double> &x, const vector<double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const vector<double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const vector<double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<vector<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<vector<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<vector<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<matrix::Dense<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const vector<double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const vector<double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const vector<double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const vector<double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<vector<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<vector<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<vector<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<vector<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const vector<double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const vector<double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const vector<double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<vector<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<vector<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<vector<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, vector<double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<vector<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const double alpha, const view1D<matrix::Dense<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, view1D<matrix::Dense<double>,double> &z){Daxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const vector<float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const vector<float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const vector<float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<vector<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<vector<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<vector<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<matrix::Dense<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const vector<float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const vector<float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const vector<float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const vector<float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<vector<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<vector<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<vector<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<vector<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const vector<float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const vector<float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const vector<float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<vector<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<vector<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<vector<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, vector<float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<vector<float>,float> &z){Saxpyz_core(alpha, x, y, z);}
void axpyz(const float alpha, const view1D<matrix::Dense<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, view1D<matrix::Dense<float>,float> &z){Saxpyz_core(alpha, x, y, z);}

double dot(const vector<double> &x, const vector<double> &y){return Ddot_core(x, y);}
double dot(const vector<double> &x, const view1D<vector<double>,double> &y){return Ddot_core(x, y);}
double dot(const vector<double> &x, const view1D<matrix::Dense<double>,double> &y){return Ddot_core(x, y);}
double dot(const view1D<vector<double>,double> &x, const vector<double> &y){return Ddot_core(x, y);}
double dot(const view1D<vector<double>,double> &x, const view1D<vector<double>,double> &y){return Ddot_core(x, y);}
double dot(const view1D<vector<double>,double> &x, const view1D<matrix::Dense<double>,double> &y){return Ddot_core(x, y);}
double dot(const view1D<matrix::Dense<double>,double> &x, const vector<double> &y){return Ddot_core(x, y);}
double dot(const view1D<matrix::Dense<double>,double> &x, const view1D<vector<double>,double> &y){return Ddot_core(x, y);}
double dot(const view1D<matrix::Dense<double>,double> &x, const view1D<matrix::Dense<double>,double> &y){return Ddot_core(x, y);}
float dot(const vector<float> &x, const vector<float> &y){return Sdot_core(x, y);}
float dot(const vector<float> &x, const view1D<vector<float>,float> &y){return Sdot_core(x, y);}
float dot(const vector<float> &x, const view1D<matrix::Dense<float>,float> &y){return Sdot_core(x, y);}
float dot(const view1D<vector<float>,float> &x, const vector<float> &y){return Sdot_core(x, y);}
float dot(const view1D<vector<float>,float> &x, const view1D<vector<float>,float> &y){return Sdot_core(x, y);}
float dot(const view1D<vector<float>,float> &x, const view1D<matrix::Dense<float>,float> &y){return Sdot_core(x, y);}
float dot(const view1D<matrix::Dense<float>,float> &x, const vector<float> &y){return Sdot_core(x, y);}
float dot(const view1D<matrix::Dense<float>,float> &x, const view1D<vector<float>,float> &y){return Sdot_core(x, y);}
float dot(const view1D<matrix::Dense<float>,float> &x, const view1D<matrix::Dense<float>,float> &y){return Sdot_core(x, y);}

void dot(const vector<double> &x, const vector<double> &y, double &ans){ ans = dot(x, y); }
void dot(const vector<double> &x, const view1D<vector<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const vector<double> &x, const view1D<matrix::Dense<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<vector<double>,double> &x, const vector<double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<vector<double>,double> &x, const view1D<vector<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<vector<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<double>,double> &x, const vector<double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<double>,double> &x, const view1D<vector<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<double>,double> &x, const view1D<matrix::Dense<double>,double> &y, double &ans){ ans = dot(x, y); }
void dot(const vector<float> &x, const vector<float> &y, float &ans){ ans = dot(x, y); }
void dot(const vector<float> &x, const view1D<vector<float>,float> &y, float &ans){ ans = dot(x, y); }
void dot(const vector<float> &x, const view1D<matrix::Dense<float>,float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<vector<float>,float> &x, const vector<float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<vector<float>,float> &x, const view1D<vector<float>,float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<vector<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<float>,float> &x, const vector<float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<float>,float> &x, const view1D<vector<float>,float> &y, float &ans){ ans = dot(x, y); }
void dot(const view1D<matrix::Dense<float>,float> &x, const view1D<matrix::Dense<float>,float> &y, float &ans){ ans = dot(x, y); }

double nrm1(const vector<double> &x){ return Dnrm1_core(x); }
double nrm1(const view1D<vector<double>,double> &x){ return Dnrm1_core(x); }
double nrm1(const view1D<matrix::Dense<double>,double> &x){ return Dnrm1_core(x); }
float nrm1(const vector<float> &x){ return Snrm1_core(x); }
float nrm1(const view1D<vector<float>,float> &x){ return Snrm1_core(x); }
float nrm1(const view1D<matrix::Dense<float>,float> &x){ return Snrm1_core(x); }

void nrm1(const vector<double> &x, double &ans){ ans = nrm1(x); }
void nrm1(const view1D<vector<double>,double> &x, double &ans){ ans = nrm1(x); }
void nrm1(const view1D<matrix::Dense<double>,double> &x, double &ans){ ans = nrm1(x); }
void nrm1(const vector<float> &x, float &ans){ ans = nrm1(x); }
void nrm1(const view1D<vector<float>,float> &x, float &ans){ ans = nrm1(x); }
void nrm1(const view1D<matrix::Dense<float>,float> &x, float &ans){ ans = nrm1(x); }
...
void nrm2(const view1D<matrix::Dense<double>,double> &x, double &ans){ ans = nrm2(x); }
...
void scal(const double alpha, view1D<matrix::Dense<double>,double> &x){ Dscal_core(alpha, x); }
...
void scal(const float alpha, view1D<matrix::Dense<float>,float> &x){ Sscal_core(alpha, x); }

void xpay(const double alpha, const vector<double> &x, vector<double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const vector<double> &x, view1D<vector<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const vector<double> &x, view1D<matrix::Dense<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<vector<double>,double> &x, vector<double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<vector<double>,double> &x, view1D<vector<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<vector<double>,double> &x, view1D<matrix::Dense<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<matrix::Dense<double>,double> &x, vector<double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<matrix::Dense<double>,double> &x, view1D<vector<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const double alpha, const view1D<matrix::Dense<double>,double> &x, view1D<matrix::Dense<double>,double> &y) {Dxpay_core(alpha, x, y);}
void xpay(const float alpha, const vector<float> &x, vector<float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const vector<float> &x, view1D<vector<float>,float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const vector<float> &x, view1D<matrix::Dense<float>,float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<vector<float>,float> &x, vector<float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<vector<float>,float> &x, view1D<vector<float>,float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<vector<float>,float> &x, view1D<matrix::Dense<float>,float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<matrix::Dense<float>,float> &x, vector<float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<matrix::Dense<float>,float> &x, view1D<vector<float>,float> &y) {Sxpay_core(alpha, x, y);}
void xpay(const float alpha, const view1D<matrix::Dense<float>,float> &x, view1D<matrix::Dense<float>,float> &y) {Sxpay_core(alpha, x, y);}
