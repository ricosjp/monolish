// Tshi code is generated by gen_dense_diag_div.sh
...
template <>
void monolish::view_tensor_Dense<vector<double>, double>::diag_div(
    const double alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_tensor_Dense<matrix::Dense<double>, double>::diag_div(
    const double alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<double>,
                                 double>::diag_div(const double alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
template <>
...
template <>
void monolish::view_tensor_Dense<vector<float>, float>::diag_div(
    const float alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_tensor_Dense<matrix::Dense<float>, float>::diag_div(
    const float alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<float>, float>::diag_div(
    const float alpha) {
  tensor_Dense_diag_div_core(*this, alpha);
}
...
void monolish::tensor::tensor_Dense<double>::diag_div(
  ...
  tensor_Dense_diag_div_core(*this, vec.size(), vec.begin());
}
template <>
void monolish::tensor::tensor_Dense<double>::diag_div(
...
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<double>,
                                 double>::diag_div(const vector<double> &vec) {
  tensor_Dense_diag_div_core(*this, vec.size(), vec.begin());
}
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<double>, double>::
    diag_div(const view1D<vector<double>, double> &vec) {
  tensor_Dense_diag_div_core(*this, vec.size(), vec.begin());
}
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<double>, double>::
    diag_div(const view1D<matrix::Dense<double>, double> &vec) {
  tensor_Dense_diag_div_core(*this, vec.size(), vec.begin());
}
template <>
void monolish::view_tensor_Dense<tensor::tensor_Dense<double>, double>::
    diag_div(const view1D<tensor::tensor_Dense<double>, double> &vec) {
  tensor_Dense_diag_div_core(*this, vec.size(), vec.begin());
}
template <>
