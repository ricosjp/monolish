...
template <typename T>
void COO<T>::set_ptr(const size_t rN, const size_t cN, const std::vector<int> &r,
                     const std::vector<int> &c, const std::vector<T> &v) {
  Logger &logger = Logger::get_instance();
  logger.util_in(monolish_func);
  col_index = c;
  row_index = r;
...
template void COO<double>::set_ptr(const size_t rN, const size_t cN, const std::vector<int> &r,
                                   const std::vector<int> &c, const std::vector<double> &v);
template void COO<float>::set_ptr(const size_t rN, const size_t cN, const std::vector<int> &r,
                                  const std::vector<int> &c, const std::vector<float> &v);

template <typename T> void COO<T>::insert(const size_t m, const size_t n, const T value) {
  size_t rownum = m;
  if (rownum >= get_row()) {
...
template void COO<double>::insert(const size_t m, const size_t n, const double value);
template void COO<float>::insert(const size_t m, const size_t n, const float value);
