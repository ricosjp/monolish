...
template void tensor_COO<double>::convert(const tensor::tensor_Dense<double> &dense);
template void tensor_COO<float>::convert(const tensor::tensor_Dense<float> &dense);
