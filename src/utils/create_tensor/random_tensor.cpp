...
template <typename T>
tensor::tensor_COO<T>
util::random_structure_tensor(const size_t M, const size_t N,
...
template tensor::tensor_COO<double>
util::random_structure_tensor(const size_t M, const size_t N,
                              const size_t nnzrow, const double val);
template tensor::tensor_COO<float>
util::random_structure_tensor(const size_t M, const size_t N,
                              const size_t nnzrow, const float val);

template <typename T>
tensor::tensor_COO<T>
util::random_structure_tensor(const size_t M, const size_t N, const size_t L,
                              const size_t nnzrow, const T val) {
  Logger &logger = Logger::get_instance();
  logger.util_in(monolish_func);
...
template <typename T>
tensor::tensor_COO<T>
util::random_structure_tensor(const size_t K, const size_t M, const size_t N,
                              const size_t L, const size_t nnzrow,
                              const T val) {
  Logger &logger = Logger::get_instance();
  logger.util_in(monolish_func);
