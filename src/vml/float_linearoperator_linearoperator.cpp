...
void vml::add(const matrix::LinearOperator<float>& A, const matrix::LinearOperator<float>& B,
...
void vml::sub(const matrix::LinearOperator<float>& A, const matrix::LinearOperator<float>& B,
             matrix::LinearOperator<float>& C) {
  Logger &logger = Logger::get_instance();
  logger.func_in(monolish_func);
