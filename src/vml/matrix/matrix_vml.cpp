...
void sub(const matrix::Dense<double> &A, const matrix::Dense<double> &B, matrix::Dense<double> &C){mmadd_core(A, B, C);}
void sub(const matrix::Dense<float> &A, const matrix::Dense<float> &B, matrix::Dense<float> &C){mmadd_core(A, B, C);}
void mul(const matrix::Dense<double> &A, const matrix::Dense<double> &B, matrix::Dense<double> &C){mmadd_core(A, B, C);}
void mul(const matrix::Dense<float> &A, const matrix::Dense<float> &B, matrix::Dense<float> &C){mmadd_core(A, B, C);}
void div(const matrix::Dense<double> &A, const matrix::Dense<double> &B, matrix::Dense<double> &C){mmadd_core(A, B, C);}
void div(const matrix::Dense<float> &A, const matrix::Dense<float> &B, matrix::Dense<float> &C){mmadd_core(A, B, C);}
...
void sub(const matrix::Dense<double> &A, const double alpha, matrix::Dense<double> &C){smadd_core(A, alpha, C);}
void sub(const matrix::Dense<float> &A, const float alpha, matrix::Dense<float> &C){smadd_core(A, alpha, C);}
void mul(const matrix::Dense<double> &A, const double alpha, matrix::Dense<double> &C){smadd_core(A, alpha, C);}
void mul(const matrix::Dense<float> &A, const float alpha, matrix::Dense<float> &C){smadd_core(A, alpha, C);}
void div(const matrix::Dense<double> &A, const double alpha, matrix::Dense<double> &C){smadd_core(A, alpha, C);}
void div(const matrix::Dense<float> &A, const float alpha, matrix::Dense<float> &C){smadd_core(A, alpha, C);}
...
void min(const matrix::Dense<double> &A, const matrix::Dense<double> &B, matrix::Dense<double> &C){mmmax_core(A, B, C);}
void min(const matrix::Dense<float> &A, const matrix::Dense<float> &B, matrix::Dense<float> &C){mmmax_core(A, B, C);}
...
double min(const matrix::Dense<double> &C){return mmax_core<matrix::Dense<double>,double>(C);}
float min(const matrix::Dense<float> &C){return mmax_core<matrix::Dense<float>,float>(C);}
...
void sub(const matrix::CRS<double> &A, const matrix::CRS<double> &B, matrix::CRS<double> &C){mmadd_core(A, B, C);}
void sub(const matrix::CRS<float> &A, const matrix::CRS<float> &B, matrix::CRS<float> &C){mmadd_core(A, B, C);}
void mul(const matrix::CRS<double> &A, const matrix::CRS<double> &B, matrix::CRS<double> &C){mmadd_core(A, B, C);}
void mul(const matrix::CRS<float> &A, const matrix::CRS<float> &B, matrix::CRS<float> &C){mmadd_core(A, B, C);}
void div(const matrix::CRS<double> &A, const matrix::CRS<double> &B, matrix::CRS<double> &C){mmadd_core(A, B, C);}
void div(const matrix::CRS<float> &A, const matrix::CRS<float> &B, matrix::CRS<float> &C){mmadd_core(A, B, C);}
...
void sub(const matrix::CRS<double> &A, const double alpha, matrix::CRS<double> &C){smadd_core(A, alpha, C);}
void sub(const matrix::CRS<float> &A, const float alpha, matrix::CRS<float> &C){smadd_core(A, alpha, C);}
void mul(const matrix::CRS<double> &A, const double alpha, matrix::CRS<double> &C){smadd_core(A, alpha, C);}
void mul(const matrix::CRS<float> &A, const float alpha, matrix::CRS<float> &C){smadd_core(A, alpha, C);}
void div(const matrix::CRS<double> &A, const double alpha, matrix::CRS<double> &C){smadd_core(A, alpha, C);}
void div(const matrix::CRS<float> &A, const float alpha, matrix::CRS<float> &C){smadd_core(A, alpha, C);}
...
void min(const matrix::CRS<double> &A, const matrix::CRS<double> &B, matrix::CRS<double> &C){mmmax_core(A, B, C);}
void min(const matrix::CRS<float> &A, const matrix::CRS<float> &B, matrix::CRS<float> &C){mmmax_core(A, B, C);}
...
double min(const matrix::CRS<double> &C){return mmax_core<matrix::CRS<double>,double>(C);}
float min(const matrix::CRS<float> &C){return mmax_core<matrix::CRS<float>,float>(C);}
