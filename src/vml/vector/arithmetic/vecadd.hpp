...
void svadd_core(const F1 &a, const F2 alpha, F3 &y) {
  ...
  internal::vadd(y.size(), a.data()+a.get_offset(), alpha, y.data()+y.get_offset(), y.get_device_mem_stat());
...
void vvadd_core(const F1 &a, const F2 &b, F3 &y) {
  ...
  internal::vadd(y.size(), a.data()+a.get_offset(), b.data()+b.get_offset(), y.data()+y.get_offset(),
