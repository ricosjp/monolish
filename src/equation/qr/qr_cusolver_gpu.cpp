...
template <>
int equation::QR<matrix::CRS<double>, double>::cusolver_QR(matrix::CRS<double> &A, vector<double> &x,
                                      vector<double> &b) {
...
template <>
int equation::QR<matrix::CRS<float>, float>::cusolver_QR(matrix::CRS<float> &A, vector<float> &x,
                                     vector<float> &b) {
  Logger &logger = Logger::get_instance();
  logger.func_in(monolish_func);
