...
namespace monolish{
    ...
    template void equation::Jacobi<float>::apply_precond(const vector<float>& r, vector<float>& z);
    template void equation::Jacobi<double>::apply_precond(const vector<double>& r, vector<double>& z);
