...
int main(int argc, char **argv) {
  ...
  std::cout << "CRS, CG, Jacobi" << std::endl;
  ...
  if (monolish::util::build_with_gpu() == false) {
    std::cout << "LinearOperator, CG, none" << std::endl;

    if (test<monolish::matrix::LinearOperator<double>, double,
           monolish::equation::CG<monolish::matrix::LinearOperator<double>, double>,
    ...
    if (test<monolish::matrix::LinearOperator<float>, float,
           monolish::equation::CG<monolish::matrix::LinearOperator<float>, float>,
  ...
  if (monolish::util::build_with_gpu() == false) {
    std::cout << "LinearOperator, CG, Jacobi" << std::endl;
  ...
  // BiCGSTAB
  ///////////////////////////////////////////////////////////
  std::cout << "CRS, BiCGSTAB, none" << std::endl;
  ...
  std::cout << "CRS, BiCGSTAB, Jacobi" << std::endl;
  ...
  std::cout << "Dense, BiCGSTAB, none" << std::endl;

  if (test<monolish::matrix::Dense<double>, double,
           monolish::equation::BiCGSTAB<monolish::matrix::Dense<double>, double>,
           monolish::equation::none<monolish::matrix::Dense<double>, double>>(
          file, check_ans, 1.0e-8) == false) {
    return 1;
  }
  ...
  std::cout << "Dense, BiCGSTAB, Jacobi" << std::endl;
  ...
  if (monolish::util::build_with_gpu() == false) {
    std::cout << "LinearOperator, BiCGSTAB, none" << std::endl;

    if (test<monolish::matrix::LinearOperator<double>, double,
           monolish::equation::BiCGSTAB<monolish::matrix::LinearOperator<double>, double>,
             monolish::equation::none<monolish::matrix::LinearOperator<double>,
                                      double>>(file, check_ans, 1.0e-8) ==
        false) {
      return 1;
    ...
    if (test<monolish::matrix::LinearOperator<float>, float,
           monolish::equation::BiCGSTAB<monolish::matrix::LinearOperator<float>, float>,
             monolish::equation::none<monolish::matrix::LinearOperator<float>,
                                      float>>(file, check_ans, 1.0e-4) ==
        false) {
      return 1;
  ...
  if (monolish::util::build_with_gpu() == false) {
    std::cout << "LinearOperator, BiCGSTAB, Jacobi" << std::endl;
