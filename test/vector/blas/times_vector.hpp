...
template <typename T> void ans_vector_times(monolish::vector<T> &ma, monolish::vector<T> &mb, monolish::vector<T> &my) {
...
template <typename T> bool test_send_vector_times(const size_t size, double tol) {
