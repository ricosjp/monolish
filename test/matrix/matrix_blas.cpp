...
int main(int argc, char **argv) {
    ...
    if (test_matadd<monolish::matrix::CRS<double>,
                    monolish::matrix::CRS<double>,
                    monolish::matrix::CRS<double>, double>(M, N, 1.0e-8) ==
        false) {
        return 1;
    ...
    if (test_send_matadd_linearoperator<
    ...
    if (test_matsub<monolish::matrix::CRS<double>,
                    monolish::matrix::CRS<double>,
                    monolish::matrix::CRS<double>, double>(M, N, 1.0e-8) ==
        false) {
        return 1;
    ...
    if (test_send_matsub_linearoperator<
            monolish::matrix::LinearOperator<double>,
            monolish::matrix::LinearOperator<double>,
            monolish::matrix::LinearOperator<double>, double>(M, N, 1.0e-8) ==
        false) {
    ...
    // matvec Dense//
    if (test_send_matvec<monolish::matrix::Dense<double>, double>(
            M, N, 1.0e-6) == false) {
        return 1;
    }
    ...
    if (test_send_matvec_N<monolish::matrix::Dense<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
    ...
    if (test_send_matvec_T<monolish::matrix::Dense<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
    ...
    if (test_matvec<monolish::matrix::CRS<float>, float>(M, N, 1.0e-3) ==
        false) {
        return 1;
    }

    // matvec_T CRS//
    if (test_send_matvec_T<monolish::matrix::CRS<double>, double>(
            M, N, 1.0e-6) == false) {
        return 1;
    }
    ...
    if (test_send_matvec_linearoperator<
            monolish::matrix::LinearOperator<double>, double>(M, N, 1.0e-6) ==
        false) {
        return 1;
    }
    ...
    if (test_matmul<monolish::matrix::CRS<float>,
                    monolish::matrix::Dense<float>,
                    monolish::matrix::Dense<float>, float>(M, N, K, 1.0e-4) ==
        false) {
        return 1;
    ...
    if (test_send_matmul_linearoperator<
            monolish::matrix::LinearOperator<double>,
            monolish::matrix::Dense<double>, monolish::matrix::Dense<double>,
            double>(M, N, K, 1.0e-8) == false) {
        return 1;
    }
    ...
    // mscal Dense//
    if (test_send_mscal<monolish::matrix::Dense<double>, double>(
            M, N, 1.0e-8) == false) {
        return 1;
    }
    ...
    if (test_mscal<monolish::matrix::CRS<float>, float>(M, N, 1.0e-4) ==
        false) {
        return 1;
    }
    ...
    */
    ...
    if (test_send_times_row<monolish::matrix::CRS<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
    ...
    if (test_send_times_col<monolish::matrix::CRS<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
    ...
    if (test_times_row_line<monolish::matrix::CRS<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
    ...
    if (test_times_col_line<monolish::matrix::CRS<float>, float>(
            M, N, 1.0e-3) == false) {
        return 1;
    }
