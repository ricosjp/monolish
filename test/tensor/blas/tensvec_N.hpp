...
template <typename T>
void ans_tensvec_N(monolish::tensor::tensor_Dense<T> &A,
                   monolish::vector<T> &mx,
...
bool test_send_tensvec_N(const size_t M, const size_t N, const size_t L,
                         double tol) {
...
template <typename MAT, typename T>
bool test_tensvec_N(const size_t M, const size_t N, const size_t L,
                    double tol) {
